...
import (
	...
	"github.com/go-git/go-git/v5/plumbing/protocol/v2/capability"
)
...
func encodeCaps(e *advRefsEncoder) encoderStateFn {
	firstLine := "version 2\n"
	capabilities := formatCaps(e.data.Capabilities)

	e.pe.EncodeString(firstLine, capabilities, string(pktline.Flush))
	return nil
}
