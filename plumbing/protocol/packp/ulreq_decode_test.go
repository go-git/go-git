...
func (s *UlReqDecodeSuite) testDecodeOK(c *C, payloads []string, nbUploadRequestHaveCall int) (*UploadRequest, []plumbing.Hash) {
	var buf bytes.Buffer
	...
	c.Assert(nbCall, Equals, nbUploadRequestHaveCall)
