...
func (o *FSObject) Reader() (io.ReadCloser, error) {
	...
	if o.acquireRandom != nil {
		...
		if o.pack == nil {
			// If pack is nil, the packfile handle has been released
			// (e.g. during Prune()). Try to open the file from scratch.
			if o.packPath == "" || o.fs == nil {
				return nil, fmt.Errorf("go-git: packfile not available for object %s", o.hash)
			}
