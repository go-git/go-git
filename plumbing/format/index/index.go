...
// EntryOffsetTable represents the 'IEOT' index extension.
//
// It stores offsets and counts of index entries to enable efficient
// multi-threaded loading.
type EntryOffsetTable struct {
...
// EntryOffsetEntry represents an entry in the index entry offset table.
type EntryOffsetEntry struct {
